...
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 text-gray-800" id="titlee">Halaman Ubah Laporan</h1>

    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <form action="<?= base_url('member/piket/laporan/update/'. $piket['id']) ?>" method="POST">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea name="keterangan" id="ckeditor" style="width: 100%; height: 500px"><?= $laporan['keterangan'] ?></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-10">
