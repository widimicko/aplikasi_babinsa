...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 text-gray-800">Halaman tambah lampiran</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <form action="<?= base_url('member/piket/lampiran/create/'. $piket['id']) ?>" method="POST" enctype="multipart/form-data">
          <?= csrf_field() ?>
