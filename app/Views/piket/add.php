...
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 text-gray-800" id="titlee">Halaman Tambah Jadwdal Piket</h1>

    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <form action="<?= base_url('piket/create') ?>" method="POST">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control <?= session('errors.tanggal') ? 'is-invalid' : '' ?>" name="tanggal" value="<?= old('tanggal')  ?>" required>
              <div class="invalid-feedback">
